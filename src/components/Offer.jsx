...
import { Tag, ArrowRight, Flame, Gift } from 'lucide-react'

const bundles = [
  {
    title: 'Starter Protection Bundle',
    subtitle: 'Perfect for small teams (up to 5 workers)',
    items: ['5x ProGuard Elite Helmets', '5x NitriMax Pro Gloves', '5x SafeBreath N95 PRO', '1x First Aid Kit'],
    price: 59,
    originalPrice: 89,
    savings: 30,
    badge: 'Most Popular',
  ...
  },
  {
    ...
    items: ['10x ProGuard Elite Helmets', '10x Full-Body Harnesses', '10x NitriMax Pro Gloves', '5x VisionShield MAX', '2x Comprehensive First Aid Kits'],
    price: 229,
    originalPrice: 359,
    savings: 130,
    badge: 'Best Value',
  ...
  },
  {
    ...
    items: ['50x ProGuard Elite Helmets', '50x Full-Body Harnesses', '50x NitriMax Pro Gloves', 'Custom PPE Kit', 'Dedicated Account Manager', 'Annual Compliance Review'],
    price: 949,
    originalPrice: 1799,
    savings: 850,
    badge: 'Enterprise',
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex items-center justify-center gap-4 mb-14 rounded-[1.75rem] bg-slate-950/20 backdrop-blur-md border border-white/45 shadow-[0_18px_60px_rgba(15,23,42,0.14)] px-6 py-5 max-w-fit mx-auto">
          <p className="text-white font-medium text-sm">Offer expires in:</p>
            ...
            {[
              ...
              <React.Fragment key={i}>
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-white mt-1 tracking-wider">{unit.label}</span>
                </div>
